      ...
      <td className="p-3 text-lg text-gray-800">
        <fetcher.Form method="POST">
          <button
            ...
            name="id"
            value={product.id}
            className={`${isAvailable ? 'text-black bg-green-400':'text-white bg-red-500'} rounded-lg p-2 text-xs uppercase font-bold w-full border border-black hover:cursor-pointer`}
          >
